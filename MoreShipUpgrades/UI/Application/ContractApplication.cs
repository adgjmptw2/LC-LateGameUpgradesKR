...
namespace MoreShipUpgrades.UI.Application
{
    ...
    {
        const string MAIN_MENU_TITLE = "계약";
        const string CONTRACT_INFO_CURSOR_ELEMENT = "계약 정보";
        const string PICK_CONTRACT_CURSOR_ELEMENT = "계약 고르기";
        const string CURRENT_CONTRACT_CURSOR_ELEMENT = "현재 계약";

        const string RANDOM_MOON_CURSOR_ELEMENT = "랜덤 위성";
        const string SPECIFIED_MOON_CURSOR_ELEMENT = "특정 위성";
        ...
        public override void Initialization()
        {
            ...
            textElements =
                [
                    TextElement.Create("계약 관련 작업을 실행할 프롬프트를 선택하십시오."),
                    TextElement.Create(" "),
                    menu,
                ];
