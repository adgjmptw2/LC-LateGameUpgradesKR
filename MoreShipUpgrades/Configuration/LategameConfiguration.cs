...
namespace MoreShipUpgrades.Configuration
{
    ...
    public class LategameConfiguration : SyncedConfig2<LategameConfiguration>
    {
        ...
        public LategameConfiguration(ConfigFile cfg) : base(Metadata.GUID)
        {
            ...
            AffectSamples = cfg.BindSyncedEntry(topSection, "샘플에 영향", true, "활성화 시 미다스의 손이 생물 처치 시 떨어지는 샘플의 가치를 증가시킵니다.");
            AffectApparatus = cfg.BindSyncedEntry(topSection, "장치에 영향", true, "활성화 시 미다스의 손이 특수 방에서 생성되는 장치의 가치를 증가시킵니다.");
